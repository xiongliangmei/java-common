...
import com.java.tool.wx.pay.util.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        System.out.println("签名的参数：" + reqData.toString() + "签名的key" + config.getKey() + "签名的类型：" + this.signType);
    ...
    /**
     * 公账号再次进行签名 进行签名后直接返回结果
     */
    public Map<String, String> againOrder(Map<String, String> reqData) throws Exception {
        return this.againfillRequestData(reqData);
    }

    /**
     * App再次进行签名 进行签名后直接返回结果
     */
    public Map<String, String> appAgainAuthorization(Map<String, String> reqData) throws Exception {
        return this.appAgainAuthorizations(reqData);
    }
     ...
     * App再次进行签名 进行签名后直接返回结果
     */
    public Map<String, String> appAgainAuthorizations(Map<String, String> reqData) throws Exception {
        reqData.put("package", "Sign=WXPay");
        reqData.put("noncestr", WXPayUtil.generateNonceStr());
        reqData.put("partnerid", config.getMchID());
        reqData.put("timestamp", WXPayUtil.getTime());
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
        return reqData;
    }
     ...
     * 公账号再次进行签名
     */
    public Map<String, String> againfillRequestData(Map<String, String> reqData) throws Exception {
        Map<String, String> data = new HashMap<>();
        data.put("appId", reqData.get("appid"));
        data.put("nonceStr", WXPayUtil.generateNonceStr());
        data.put("package", "prepay_id=" + reqData.get("prepay_id"));
        data.put("timeStamp", WXPayUtil.getTime());
        ...
        data.put("paySign", WXPayUtil.generateSignature(data, config.getKey(), this.signType));
        return data;
    }
} // end class
